            ...
            if row:
                ...
                result = await conn.execute(
                    ...
                    UPDATE usuarios SET
                        ...
                        current_period_end    = COALESCE($6::text::timestamptz, current_period_end),
                        plan                  = COALESCE($7, plan),
                        contact_limit         = COALESCE($8::int, contact_limit)
                    WHERE email = $9
                    """,
        ...
        async with pool.acquire() as conn:
            await conn.execute(
                ...
                UPDATE usuarios SET
                    ...
                    current_period_end    = COALESCE($5::text::timestamptz, current_period_end),
